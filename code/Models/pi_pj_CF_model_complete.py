...
#this will store the third category map of products
third_category={}
...
#this will store the market basket for users
market_basket={}
...
#	count+=1
	...
	#	break
#exit()
#this fucntion will calculate the cosine similarity between two customers
...
#this will calculate the frequency of item in products
...
#this function will return the top 10 associated third category
...
#this function will create the candidate product set from top 10 categories
...
#this will return products with their final score
